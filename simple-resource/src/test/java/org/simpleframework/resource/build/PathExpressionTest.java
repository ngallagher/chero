...
import org.simpleframework.resource.build.MethodCompiler;
import org.simpleframework.resource.build.MethodMatcher;
import org.simpleframework.resource.build.PathPattern;
...
public class PathExpressionTest extends TestCase {
   ...
   public void testPatternForInteger() throws Exception {
      ...
      MethodMatcher parser = new MethodCompiler(path, integer).compile(GET.class);
   ...
   public void testPatternForIntegerAndDouble() throws Exception {
      ...
      MethodMatcher parser = new MethodCompiler(path, integer, decimal).compile(GET.class);
   ...
   public void testSlash() throws Exception {
      ...
      MethodMatcher parser = new MethodCompiler(path).compile(GET.class);
